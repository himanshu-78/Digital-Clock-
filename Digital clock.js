...
function setAlarm(){
   ...
   if(time.getHours()==lunch){
      ...
      document.getElementById("imgM").src="./image/lunchmain.png"
   ...
   if(time.getHours()==nap){
      ...
      document.getElementById("imgM").src="./image/tea.jpg"
   }
   if(time.getHours()==night){
      document.getElementById("text").innerText="Good Night !! "
      document.getElementById("imgM").src="./image/sleepmain.png"
